...
class SubScript:
    ...
    def parse_b(self, b):
        if b == 'method.app::sv_animcmd.ATTACK_lua_State' or b == 'method.app::sv_animcmd.ATTACK_ABS_lua_State' or b == 'method.app::sv_animcmd.SEARCH_lua_State' or 'method.app' in b:
